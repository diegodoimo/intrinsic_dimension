...
def load_isomap(save = False):
    "isomap faces"
    mat = scipy.io.loadmat('../datasets/real/face_data.mat')
...
def load_isolet(save =False):
    ...
    isolet_train = np.genfromtxt('../datasets/real/isolet1+2+3+4.data', delimiter = ',')[:, :-1]
    isolet_val = np.genfromtxt('../datasets/real/isolet5.data', delimiter = ',')[:, :-1]
...
def load_mnist(save = False):
    ...
    mnist_mat = scipy.io.loadmat(f'../datasets/real/mnist.mat')
